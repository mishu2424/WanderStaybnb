...
const SliderCard = ({ img, location, rating, title }) => {
    ...
    <div className="relative">
      ...
      {bookmarked ? (
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          fill="currentColor"
          className="absolute top-2 right-2 z-50 w-6 h-6 text-red-500 cursor-pointer"
        ...
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="absolute top-2 right-2 z-50 w-6 h-6 text-white drop-shadow cursor-pointer"
