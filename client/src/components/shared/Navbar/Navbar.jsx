      ...
      >
        <div className="flex items-center gap-3">
          <div className="flex gap-2 items-center">
            <Link to={"/"}>
              {
                path==='/' ? <img className="w-auto h-12 object-cover rounded-full" src="https://i.ibb.co/DPHbX3Py/Chat-GPT-Image-Oct-5-2025-03-58-18-PM.png"/>:<img className="w-auto h-12" src={logo} alt="" />
              }
            </Link>
          </div>

          <div className="flex items-center gap-3">
            <label className="toggle text-base-content border border-green-800">
              <input
            ...
            {time && (
              <span className={`bg-white px-2 font-bold text-xs hidden md:flex text-green-800`}>
                {time}
              </span>
            )}
          </div>
        ...
        <div className="flex-none">
          <ul className={`menu menu-horizontal px-1 text-green-800 font-semibold`}>
            <li>
              {path === "/" ? (
                <NavLink to={"/rooms"} className={'bg-white'}>Categories</NavLink>
              ) : (
